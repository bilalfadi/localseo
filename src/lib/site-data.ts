...
export const serviceCards = [
  ...
  },
  {
    ...
    description:
      "Find intent-rich terms people use before they call, book, or visit nearby businesses.",
    href: "/services",
  },
  {
    title: "Location Page SEO",
    description:
      "Design conversion-focused pages for each area you target with content that aligns to local search behavior.",
    href: "/services",
  },
  {
    title: "Local SEO Reporting",
    description:
      "Track map pack visibility, call trends, direction requests, and keyword movement in one dashboard.",
    href: "/services",
  },
];
...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    flag: "🇳🇿",
    service: "Multi-location Framework",
